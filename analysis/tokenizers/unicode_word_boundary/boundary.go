...
import "log"
import "unsafe"
import "github.com/couchbaselabs/cbfullofit/analysis"
...
func (t *UnicodeWordBoundaryTokenizer) Tokenize(input []byte) analysis.TokenStream {
	...
	t.bi = C.ubrk_open(C.UBRK_WORD, t.locale, myUCharPointer, -1, &err)
